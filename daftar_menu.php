...
<html lang="en">
  <head>
    ...
    <title>Martabak Solo Baru</title>
  </head>
  <body>
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>MARTABAK</strong></a>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> <strong>By Baksorabaya</strong></p> 
          </div>
          </div>
